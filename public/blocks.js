...
outsideDivs.attr("class", function(d,i) {return "delegateBox dist"+(i+1)});
outsideDivs.attr("title",function(d,i) {return i+1;});
outsideDivs.style("height", function(d) {return (d*5)+"px"});
outsideDivs.on("mouseover", function(d,i) { highlight("dist"+(i+1)); });
outsideDivs.on("mouseout", function(d,i) { highlight(null); });
